...
function importPhpFiles(){
    ...
    require "../../util/Util.php";
    //models
    require "../../models/DeudorModel.php";
    //services
    require "../../services/DeudorService.php";
}
...
function returnDataDELETE( $link ){
    $id = $_GET[ "id" ];
    echo DeudorService::delete( $link , $id );
}
...
function returnDataPOST( $link ){
    ...
    $returnInfo = DeudorService::save( $link , $newElement );
    echo $returnInfo;
}
...
function returnDataGET( $link ){
    if( isset( $_GET[ "id" ] ) ){
        $id = $_GET[ "id" ];
        echo json_encode( DeudorService::getById( $link , $id ) );
    }else{
        echo json_encode( DeudorService::getAll( $link ) );
    }
}
