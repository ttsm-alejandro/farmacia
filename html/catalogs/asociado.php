...
<html>
    <head>
        ...
        <!-- Controller -->
        <script src="../../js/catalogs/asociadoCtrl.js"></script>
    </head>
    
    <body ng-app="miApp" >
        <div class="container" ng-controller="asociadoCtrl" 
             ng-init="
                ...
                <?php if( !isset( $_GET[ "id" ] ) ){ ?>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" ng-model="filterAsociadoRFC">
                            <span ng-click="filterAsociadoRFC = ''" class="input-group-addon"><i class="glyphicon glyphicon-repeat"></i></span>
                        </div>
                        ...
                        <div style="overflow: scroll; max-height: {{ userScreenHeight }};">
                            <table class="table table-hover">
                                ...
                                <tr ng-repeat="row in tableContent | filter : { rfc : filterAsociadoRFC } " 
