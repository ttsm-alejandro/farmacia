...
miApp.controller( 'deudorCtrl'  ,['$scope' , '$http' , '$window' , function( $scope , $http , $window ){
    /**** variables ****/
    //URL
    var deudorResourceUrl = serviceUrl + "php/resources/catalogs/DeudorResource.php";
    $scope.relativeUrl = "../../";
    ...
    $scope.getData = function(){
        ...
        $http({
            url: deudorResourceUrl + "?user=" + $scope.user + "&token=" + $scope.token,
            method: "GET"
        })
    ...
    $scope.getDataById = function( id ){
        ...
        $http({
            url: deudorResourceUrl + "?user=" + $scope.user + "&token=" + $scope.token + "&id=" + id,
            method: "GET"
        })
        .then(function(response) {
            if(response.data == "ACCESS DENIED" ){
    ...
    $scope.deleteInDB = function(){
        ...
        $http({
            url: deudorResourceUrl + "?user=" + $scope.user + "&token=" + $scope.token + "&id=" + $scope.details.id + "&delete=ok",
            method: "DELETE"
        })
        .then(function(response) {
            $scope.cleanDetails();
    ...
    //No pueden existir 2 deudors con el mismo RFC
